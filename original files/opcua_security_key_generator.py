...
subject = issuer = x509.Name([
    ...
    x509.NameAttribute(NameOID.COMMON_NAME, u"MyOPCUAServer"),
])
...
with open("server_certificate.der", "wb") as f:
    f.write(cert.public_bytes(serialization.Encoding.DER))

print("Done! Generated server_private_key.pem and server_certificate.der")
